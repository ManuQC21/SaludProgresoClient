...
public class CitasVigentesViewHolder extends RecyclerView.ViewHolder {
    ...
    private CitasVigentesAdapter adapter;
    private CitasViewModel citasViewModel;

    public CitasVigentesViewHolder(@NonNull View itemView, CitasVigentesAdapter adapter, CitasViewModel citasViewModel) {
        super(itemView);
